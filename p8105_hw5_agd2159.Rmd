...
I will attempt to create an iterated data frame given the model design specifications using the `expand_grid` function and `map`. Using template from class `simulations.rmd` worksheet.
